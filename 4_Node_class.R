...
Node_attribute<- read.table("BoT/MenareadyBOT 0.480 centrality.txt", header = TRUE, sep = "\t")
module<- read.table("BoT/MenareadyBOT 0.480 fast_greedy modularity.txt", header = TRUE, sep = "\t",skip = 2)
...
write.csv(Node_attribute,paste("Node_attribute_BOT",".csv",sep=""),row.names=FALSE)
